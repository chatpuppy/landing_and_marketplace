    ...
    <>
      ...
      <Box mx={40} fontSize={20} lineHeight={10}>
        <p>
          ...
          ByteConnect PTE Ltd. (“<strong>Company</strong>”, “<strong>we</strong>
          ”, “<strong>our</strong>”, or “<strong>us</strong>”) collects, uses,
          shares, and stores personal information of users of its websites,{' '}
          <a href="https://chatpuppy.com/">https://chatpuppy.com/</a> and
          Android/ios Apps. This Policy applies to the Sites, applications,
          products and services (collectively, “<strong>Services</strong>”) on
          or in which it is posted, linked, or referenced.{' '}
        </p>
        <p>
          ...
          retention of your information as described in this Policy. If you have
          not done so already, please also review our terms of use. The terms of
          use contain provisions that limit our liability to you and require you
          to resolve any dispute with us on an individual basis and not as part
          of any class or representative action. IF YOU DO NOT AGREE WITH ANY
          PART OF THIS PRIVACY POLICY OR OUR TERMS OF USE, THEN PLEASE DO NOT
        ...
        <p>
          <strong>We will not collect any information from you</strong>. We will
          never ask you to share your personal information and private keys or
          wallet seed. Never trust anyone or any site that asks you to enter
        ...
        <p>
          We do not use or share the personal information with any
          organizations.
        </p>
        <p>
          <strong>HOW INFORMATION IS SECURED</strong>{' '}
        </p>
        <p>
          ...
          problems, assist with any investigation, enforce our Terms of Use, and
          other actions permitted by law. To determine the appropriate retention
          ...
          from unauthorized use or disclosure of your personal information, the
        ...
        <p>
          ...
          inform the child that he or she cannot use the Sites and subsequently
          we will delete that information.
        </p>
        <p>
          <strong>MARKETING AND MOBILE COMMUNICATIONS AND SHARING</strong>
        </p>
        <p>
          if you have downloaded our mobile application and enabled push
          notifications on your mobile device, we may send you alerts and
          notifications through push notifications, for example, to communicate
          status updates on our Services. However, you may choose to disable
          these notifications (except for the initial notification intended to
        ...
        <p>
          This Privacy Notice does not address, and we are not responsible for,
          the privacy practices of any third parties, including those that
          operate websites to which our Sites link. The inclusion of a link on
          our Sites does not imply that we or our affiliates endorse the
          practices of the linked website.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          the Sites (or as otherwise indicated at the time of posting). In all
          cases, your continued use of the Sites or Services after the posting
          of any modified Privacy Policy indicates your acceptance of the terms
